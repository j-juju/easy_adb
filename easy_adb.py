...
def download(path):
    ...
    os.system("adb pull "+path+" "+os.getcwd())
...
def main():
    ...
    try:
            ...
            elif userInput.lower()[0:3] == "cat":

                if (len(userInput) < 4):

                    os.system("adb shell cat")
            ...
            elif userInput.lower()[0:2] == "cd":

                if (len(userInput) < 3):

                    os.system("adb shell cd")
